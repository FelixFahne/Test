...
const labelColors = {
    ...
    'conversation opening': '#ffcccb',
    'conversation closing': '#f3d1f4',
...
function collectAnnotatedData() {
    ...
    const labelLevels = {
        ...
        'conversation opening': 'Dialogue level',
        'conversation closing': 'Dialogue level',
...
document.getElementById('add-custom-label').style.display = 'none';
document.getElementById('custom-label-name').style.display = 'none';
